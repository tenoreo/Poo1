 ...
 * @author kenda
 */
public class ListarViajes extends javax.swing.JFrame {

    /**
     * Creates new form ListarViajes
     */
    public ListarViajes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbbEstado.setFont(new java.awt.Font("Consolas", 2, 18)); // NOI18N
        cbbEstado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "En confección", "Aprobado", "Cancelado", " " }));

        jButton1.setText("Aprobar Viaje");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarViajes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarViajes().setVisible(true);
            }
        });
    }
